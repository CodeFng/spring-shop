...
public enum ResultCodeEnum {
    ...
    PHONE_IS_EXISTENT(10007, "phone is existent", "手机号已被注册"),
    EMAIL_IS_EXISTENT(10008, "email is existent", "该邮箱已被注册"),
    ...
    /* -------   短信验证的状态码----------- */
    SMS_MSG_ERROR(70001,"send sms error","发送验证码失败"),
    SMS_CODE_ERROR(70002,"code is error","验证码错误");
    /**
     * 返回码
     */
